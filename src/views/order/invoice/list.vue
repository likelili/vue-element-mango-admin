<template>
	...
	<div class="bg-white px-3" style="margin: -20px;margin-top: -1rem;margin-bottom: 0!important;">
		...
		<el-table border class="mt-3" :data="tableData" style="width: 100%" @selection-change="handleSelectionChange">
			...
			<el-table-column align="center" prop="price" label="抬头"></el-table-column>

			<el-table-column align="center" prop="content" label="发票内容"></el-table-column>

			<el-table-column align="center" prop="code" label="纳税人识别号"></el-table-column>
